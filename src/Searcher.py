...
class DuckDuckGoSearcher:
    ...
    def search_articles(self, keywords, max_results):
    ...
    def search_videos(self, keywords, max_results):
    ...
    async def search_images(self, keywords, max_results):
    ...
    async def search_all(self, keywords, max_results, imgkey):
